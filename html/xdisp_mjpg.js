...
function changeImgSize(canvas, type) { //改变img大小，
    var isFullscreen = document.isFullScreen || document.mozIsFullScreen || document.webkitIsFullScreen || window.fullScreen;//document.fullscreenEnabled || window.fullScreen || document.webkitIsFullScreen || document.msFullscreenEnabled;
    if (isFullscreen) {
